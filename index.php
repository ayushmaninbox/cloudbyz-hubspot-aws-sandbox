...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom py-3">
    <div class="container">
      <a class="navbar-brand font-weight-bold text-dark" href="index.php" style="font-family: 'Poppins', sans-serif; font-size: 1.3rem;">
        <span class="text-primary"><i class="fas fa-layer-group mr-2"></i></span>BlogPortal
      </a>
